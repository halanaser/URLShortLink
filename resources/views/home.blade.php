...
<div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-12 col-md-5 col-lg-6 order-md-2 text-center">
                    <!-- Image -->
                    <figure class="w-100">
                        <img alt="Image placeholder" src="{{asset('front/images/flags/illustration-3.svg')}}" class="img-fluid mw-md-120">
                    </figure>
                </div>
				...
				<div class="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
					...
					Short links, <strong class="text-primary"> big results</strong>
                    </h1>
                    <!-- Text -->
					...
					@auth
                        <a href="{{ url('/shortlink') }}" class="btn btn-primary btn-icon" target="_self">
					@else
					
						<a href="{{ route('login') }}" class="btn btn-primary btn-icon" target="_self">
