	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index.html"><img src="{{asset('front/images/logo3.png')}}" alt=""></a>
				</div>
									...
									<ul>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-online"><img src="{{asset('front/images/user-avatar-small-03.jpg')}}" alt=""></span>
												<div class="notification-text">
													<strong>David Peterson</strong>
													<p class="notification-msg-text">Thanks for reaching out. quite busy right now on many...</p>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-offline"><img src="{{asset('front/images/user-avatar-small-02.jpg')}}" alt=""></span>
												<div class="notification-text">
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-online"><img src="{{asset('front/images/user-avatar-placeholder.png')}}" alt=""></span>
												<div class="notification-text">
				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						...
						<ul class="user-menu-small-nav">
							...
							<li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('submit-form').submit();" >><i class="icon-material-outline-power-settings-new"></i> Logout</a></li>
